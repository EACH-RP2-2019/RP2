...
public class OpenCV_CascadeFacesSuperior {
	...
	public static List<Rectangle> detecta(Mat matImagemColorida, Mat matImagemCinza) {
		...
		List<Rectangle> facesSuperiores = new ArrayList<>();
		for (Rect face : facesDetectadas.toArray()) {
			facesSuperiores.add(new Rectangle(face.x, face.y, face.width, face.height *60 / 100));
		}
		
		return facesSuperiores;
	}
}
